    ...
    <div>
                      ...
                      <div className={classes.cardDetails}>
                        <CardContent>
                          ...
                          <Typography variant="subtitle1" paragraph>
                            Use your own photo or logo, and Forms will pick just
                            the right colors to complete your own unique form,
                            or choose from a set of curated themes to set the
                            tone. We can store images for future.
                          </Typography>
                        </CardContent>
                      </div>
                      <Hidden xsDown>
                    ...
                    <Card className={classes.card}>
                      <div className={classes.cardDetails}>
                        <CardContent>
                          ...
                          <Typography variant="subtitle1" paragraph>
                            Responses to your surveys are neatly and
                            automatically collected in Forms, with real time
                            response info and charts. Or, download a csv/json or
      ...
      <footer className={classes.footer} style={{}}>
        ...
        >
          ...
          {". "}
          Feel free to use anything that you find helpful, Give credit if you
          want.
        </Typography>
        <Copyright />
      </footer>
